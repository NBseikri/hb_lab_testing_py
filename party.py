...
def is_mel(name, email):
    ...
    >>> is_mel("Nada Bseikri", "mel@ubermelon.com")
    True

    >>> is_mel("Mel Melitpolski", "nada@ubermelon.com")
    True

    >>> is_mel("Mel Melitpolski", "mel@ubermelon.com")
    True

    >>> is_mel("Nada Bseikri", "nada@ubermelon.com")
    False
    """
...
def most_and_least_common_type(treats):
    ...
    >>> treats_test = [{'type': 'dessert','description': 'Chocolate mousse','who': 'Leslie'},{'type': 'dessert','description': 'Cardamom-Pear pie','who': 'Joel'},{'type': 'appetizer','description': 'Humboldt Fog cheese','who': 'Meggie'}]

    >>> most_and_least_common_type(treats_test)
    ("dessert", "drink")
    """
